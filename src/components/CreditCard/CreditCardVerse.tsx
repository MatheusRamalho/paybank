...
export function CreditCardVerse({ className }: CreditCardVerseProps) {
    return (
        <div className={twMerge('w-56 h-80 md:w-64 md:h-96 rounded-2xl border-2 border-[#4E5C37] bg-gradient-g7 shadow-s3 backdrop-blur-lg', className)}>
            ...
            <div className="absolute top-6 right-4">
                ...
                <h6 className="text-white-light uppercase font-header font-medium text-sm leading-[150%] mt-8"> •••• 4859 </h6>
            </div>
        </div>
    )
}
