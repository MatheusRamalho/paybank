...
export function CreditCardFront({ className }: CreditCardFrontProps) {
    return (
        <div
            className={twMerge(
                'w-56 h-80 md:w-64 md:h-96 rounded-2xl border-2 border-secondary-700/95 bg-gradient-g6 shadow-s3 backdrop-blur-lg',
                className,
            )}
            style={{
        ...
        >
            ...
            <div className="absolute bottom-6 left-4">
                <h6 className="text-white-light uppercase font-header font-medium text-sm leading-[150%] mb-4">
                    {' '}
                    Matheus RAMALHO{' '}
                </h6>
