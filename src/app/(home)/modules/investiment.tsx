        ...
        <Section id="section-6" legend="">
            <div className="flex-1 w-full m-4 py-4 px-0">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center justify-between">
                        <h5 className="mt-2 font-bold font-header text-2xl">
                            R$ <span className="money-investment">1000</span>{' '}
                        </h5>
                ...
                <div className="">
                    ...
                    <div className="flex items-center justify-between">
                        <h5 className="mt-2 font-bold font-header text-2xl">
                            {' '}
                            <span className="time-investment">12</span> meses
                        </h5>
            ...
            <div className="flex-1 m-4 py-4 px-0">
                ...
                <div className="border-t-2 border-t-white-darken mt-8">
                    ...
                    <h2 className="font-header font-medium text-5xl uppercase leading-[140%] bg-gradient-g5 bg-clip-text text-transparent my-2">
                        R$ <span className="result-investment">60845.54</span>{' '}
                    </h2>
